...
| CVEs by month | `archives/2024/index.json` → Month → `_links.cve-json.href` |
...
1. GET `archives/2024/index.json` (or current year)
2. Navigate to month via `_links.cve-json.href` → e.g. `archives/2024/07/cve.json`
